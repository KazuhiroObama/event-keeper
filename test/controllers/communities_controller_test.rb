...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post communities_url, params: { community: { icon: @community.icon, image: @community.image, name: @community.name, summary: @community.summary } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { icon: @community.icon, image: @community.image, name: @community.name, summary: @community.summary } }
